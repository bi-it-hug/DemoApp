...
public sealed class NotificationService(LocalStorageService storage, ISnackbar snackbar)
{
	...
	public async Task AddAsync(Notification notification, bool callSnackbar = false)
	{
		_notifications.Insert(0, notification);
		await SaveAsync();
		if (callSnackbar == true) snackbar.Add(notification.Title, notification.Severity);
	}
